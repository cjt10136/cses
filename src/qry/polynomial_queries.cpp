...
void app(int i, long x1, long x2, int l2, int r2)
{
  st[i].s +=
      (r2 - l2) * x1 + x2 * (long{r2 - 1} * r2 / 2 - long{l2 - 1} * l2 / 2);
  st[i].lz1 += x1;
  st[i].lz2 += x2;
}
...
void upd2(int l1, int r1, long x1, long x2, int i = 0, int l2 = 0, int r2 = n)
{
  if (l1 <= l2 && r2 <= r1) {
    app(i, x1, x2, l2, r2);
    return;
